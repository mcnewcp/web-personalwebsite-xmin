...
`leaflet` provides several helper functions to define color functions for use within map building.  An explanation of these functions can be found [here](https://rstudio.github.io/leaflet/colors.html).  Below, I'm going to use `colorFactor()` to color map the values of our new residence variable and call this color function `cols()`.  I'll then define our fill colors by passing our new residence variable to the `cols()` function.
